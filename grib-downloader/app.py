...
def download_pressure(levelOfDetail):
  grib_downloader.download_gfs(levelOfDetail, "PRES", "lev_surface", "../data/gfs/pressure/")
  threading.Timer(20.0, updateGribFiles, [levelOfDetail]).start()

def download_wind(levelOfDetail):
  grib_downloader.download_gfs(levelOfDetail, "UGRD,VGRD", "lev_10_m_above_ground", "../data/gfs/wind/")
  threading.Timer(20.0, updateGribFiles, [levelOfDetail]).start()

def download_temperature(levelOfDetail):
  grib_downloader.download_gfs(levelOfDetail, "TMP", "lev_surface", "../data/gfs/temp/")
  threading.Timer(20.0, updateGribFiles, [levelOfDetail]).start()
